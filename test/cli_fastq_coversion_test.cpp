...
{
    app_test_result const result = execute_app("panmap");
...
{
    app_test_result const result = execute_app("panmap", "-v");
...
{
    app_test_result const result = execute_app("panmap", data("in.fastq"));
...
{
    app_test_result const result = execute_app("panmap", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("panmap", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("panmap", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("panmap", data("in.fastq"), "-o", "does_not_exist/out.fasta");
